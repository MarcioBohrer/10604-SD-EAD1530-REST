...
function TPedidoRepository.GETpedido(const ADocumentoCliente: string): TPedidoRetornoDTO;
begin
  ...
  if (FFDQuery.RecordCount = 0) then
    raise Exception.Create('Não foi encontrado pedido para o documento informado.');
